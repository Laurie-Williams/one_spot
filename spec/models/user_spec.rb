...
describe User do
  ...
  describe "#has_any_role?" do
    ...
    describe "role list includes a user's role" do
      ...
      before { stub_role_where_with args: {user: user, resource: account, role_names: role_list}, response: [role] }
    ...
    describe "role list does not include any user's role" do
      ...
      before { stub_role_where_with args: {user: user, resource: account, role_names: role_list}, response: [] }
