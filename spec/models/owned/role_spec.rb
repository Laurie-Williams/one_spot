    ...
    describe "#self.i_where" do
      ...
      describe "matching roles exist" do
        ...
        it "returns only matching roles in list" do
          ...
          expect(described_class.i_where(user: user, resource: account, name: role_list)).to contain_exactly(role_1, role_2)
        end
      end
      ...
      describe "matching role does not exist" do
        ...
        it "returns nil" do
          ...
          expect(described_class.i_where(user: user, resource: account, name: role_list)).to be_empty
        end
      end
    end
